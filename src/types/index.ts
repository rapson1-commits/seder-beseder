...
// ── SIDE OPTIONS ─────────────────────────────────────────────────────────────
// Use these for forms instead of a plain array of strings.
// `value` matches the DB CHECK constraint and the FamilySide type exactly.
// `label` is the Hebrew display text shown in the UI.
export const SIDE_OPTIONS: { value: FamilySide; label: string }[] = [
  { value: 'אבא',        label: 'צד אבא' },
  { value: 'אמא',        label: 'צד אמא' },
  { value: 'בן/בת זוג', label: 'בן/בת זוג' },
  { value: 'אחר',        label: 'אחר' },
]
